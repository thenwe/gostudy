...
type SayHelloClient interface {
	SayHello(ctx context.Context, in *User, opts ...grpc.CallOption) (*Addr, error)
}
...
func (c *sayHelloClient) SayHello(ctx context.Context, in *User, opts ...grpc.CallOption) (*Addr, error) {
	out := new(Addr)
	err := c.cc.Invoke(ctx, "/service.SayHello/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SayHelloServer interface {
	SayHello(context.Context, *User) (*Addr, error)
...
func (UnimplementedSayHelloServer) SayHello(context.Context, *User) (*Addr, error) {
...
func _SayHello_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.SayHello/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SayHelloServer).SayHello(ctx, req.(*User))
	}
